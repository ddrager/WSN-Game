...
public class SettingsMsg extends net.tinyos.message.Message {
    ...
    /** Create a new SettingsMsg of size 6. */
    public SettingsMsg() {
    ...
    public String toString() {
      ...
      try {
        s += "  [ignoreId=0x"+Long.toHexString(get_ignoreId())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      return s;
    }
    ...
    /**
     * Return the value (as a short) of the field 'targetId'
     */
    public short get_targetId() {
        return (short)getUIntBEElement(offsetBits_targetId(), 8);
    }
    ...
    public void set_targetId(short value) {
        setUIntBEElement(offsetBits_targetId(), 8, value);
    }
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: ignoreId
    //   Field type: short, unsigned
    //   Offset (bits): 40
    //   Size (bits): 8
    /////////////////////////////////////////////////////////
    ...
    /**
     * Return whether the field 'ignoreId' is signed (false).
     */
    public static boolean isSigned_ignoreId() {
        return false;
    }

    /**
     * Return whether the field 'ignoreId' is an array (false).
     */
    public static boolean isArray_ignoreId() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'ignoreId'
     */
    public static int offset_ignoreId() {
        return (40 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'ignoreId'
     */
    public static int offsetBits_ignoreId() {
        return 40;
    }

    /**
     * Return the value (as a short) of the field 'ignoreId'
     */
    public short get_ignoreId() {
        return (short)getUIntBEElement(offsetBits_ignoreId(), 8);
    }

    /**
     * Set the value of the field 'ignoreId'
     */
    public void set_ignoreId(short value) {
        setUIntBEElement(offsetBits_ignoreId(), 8, value);
    }

    /**
     * Return the size, in bytes, of the field 'ignoreId'
     */
    public static int size_ignoreId() {
        return (8 / 8);
    }

    /**
     * Return the size, in bits, of the field 'ignoreId'
     */
    public static int sizeBits_ignoreId() {
        return 8;
    }
